...
Cách dùng:
  python tools/draw_direction_lines.py
  python tools/draw_direction_lines.py --image frame.jpg
  python tools/draw_direction_lines.py --video data/carPark.mp4
...
def main():
    ...
    parser.add_argument("--output", "-o", type=str, default=str(PROJECT_ROOT / "config" / "roi_lines.json"),
    ...
    if args.video is None and args.image is None:
        args.video = str(PROJECT_ROOT / "data" / "carPark.mp4")
